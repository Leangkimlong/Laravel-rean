...
// CRUD with build in query (collection of array)
Route::get('/',function() {
    // Get function or read
    // $user = DB::table('users')->get();
    // $user = DB::table('users')->where('id', 3)->get(); // with where condition

    // Create function or insert 
    // $user = DB::table('users')->insert([
    //     'email' => 'mizterlong02@gmail.com',
    //     'name' => 'long02',
    //     'password' => '12345678'
    // ]);
    ...
    //     'name' => 'Lay02',
    //     'email' => 'mizterlay02@gmail.com'
    // ]);

    // Delete function or remove
